...
var squareSide, regexTemp, userPhraseRowSplit;
var inputArray = [];
...
var encrypt = function(input){
  ...
  squareSide = Math.ceil(Math.sqrt(formattedInput.length));
  regexTemp = new RegExp(".{1," + squareSide + "}");
